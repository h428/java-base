package com.hao.base.common.builder;
...
import com.hao.base.common.util.simple.ObjectUtil;
...
public class ObjectMapperBuilder {
    ...
    public ObjectMapper build() {
        ...
        if (saveType) {
            ...
            // objectMapper.enableDefaultTyping(DefaultTyping.NON_FINAL, As.PROPERTY); // 过时代码
            // 注意使用 activateDefaultTyping 替代过时的 enableDefaultTyping
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        PageQuery user = ObjectUtil.randomInstance(PageQuery.class);
